  ...
  return (<>
    ...
    <div className="flex flex-col items-center lg:bg-[url('/images/portfolio.png')] bg-[url('/images/sm-background.png')] lg:lg-contain bg-contain lg:bg-repeat-x bg-no-repeat pt-12">
      <div className="lg:flex lg:flex-row lg:w-[1000px] xl:w-[1200px] gap-5 bg-no-repeat">
        <Smartway img="./images/site institucional hidrico quimica.png" siteUrl='https://hidrico-institucional.vercel.app/' title="Institucional - Hídrico Química" description="ㅤ" category="Química / Indústria"/>
      ...
      <div className="lg:flex lg:flex-row lg:w-[1000px] xl:w-[1200px] gap-5 bg-no-repeat">
        ...
        <Smartway img="./images/dashboard financeiro integrado com enpoint de CRM.png" siteUrl='#' title="Dashboard - Financeiro integrado com CRM" description="ㅤ" category="Fintech"/>
        <Smartway img="./images/Agente de IA para Whatsapp + dashboard administrativo.png" siteUrl='#' title="Agente de IA para WhatsApp + Dashboard" description="ㅤ" category="Inteligência Artificial"/>
        </div>
      <div className="lg:flex lg:flex-row lg:w-[1000px] xl:w-[1200px] gap-5 bg-no-repeat">
        ...
        <Smartway img="./images/landing page ery santos tricologista.png" siteUrl='https://lp.erysantostricologista.com.br/' title="Landing Page - Tricologista" description="ㅤ" category="Saúde"/>
        <Smartway img="./images/LAnding page para campanha game changer.png" siteUrl='https://gamechanger.reliveclinic.com.br/' title="Landing Page - Game Changer" description="ㅤ" category="Saúde / Estética"/>
      </div>
      <div className="lg:flex lg:flex-row lg:w-[1000px] xl:w-[1200px] gap-5 bg-no-repeat">
        <Smartway img="./images/landing page exibindo lancamentos de madeira.png" siteUrl='https://lancamentos.grupoindusparquet.com.br/' title="Landing Page - Grupo Indusparquet" description="ㅤ" category="Construção / Decoração"/>
